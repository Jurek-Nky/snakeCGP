...
PlaneGeometry::PlaneGeometry(QMatrix4x4 model)
    : arrayBuffer(QOpenGLBuffer::VertexBuffer), texture(nullptr) {
...
void PlaneGeometry::initTexture() {
  texture =
      new QOpenGLTexture(QImage(":/resources/textures/brick.png").mirrored());
...
void PlaneGeometry::drawPlaneGeometry(QOpenGLShaderProgram *program,

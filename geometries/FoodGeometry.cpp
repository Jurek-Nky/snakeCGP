...
FoodGeometry::FoodGeometry(QMatrix4x4 model) : indexBuffer(QOpenGLBuffer::IndexBuffer), texture(nullptr) {
...
void FoodGeometry::drawFoodGeometry(QOpenGLShaderProgram *program, QMatrix4x4 projection) {
...
void FoodGeometry::initTexture() {
    texture = new QOpenGLTexture(QImage(":/resources/textures/cube.png").mirrored());

...
MenuWidget::MenuWidget(QWidget *parent) :
    ...
    ui->soundOverallSlider->setTickPosition(QSlider::TickPosition::TicksBothSides);
    ...
    connect(this->ui->musicCheckbox, SIGNAL(clicked(bool)), this, SLOT(setMusicEnabled(bool)));
    connect(this->ui->soundEffectCheckbox, SIGNAL(clicked(bool)), this, SLOT(setSoundEffectsEnabled(bool)));
    connect(this->ui->soundOverallCheckbox, SIGNAL(clicked(bool)), this, SLOT(setSoundEnabled(bool)));
...
void MenuWidget::setSoundEnabled(bool b) {
    ...
    this->ui->musicCheckbox->setCheckState(
            !b ? Qt::CheckState::Unchecked : Options::musicEnabled ? Qt::CheckState::Checked
